...
class IndexPage extends React.Component{
  ...
  state = {
    ...
    fileName : 'https://d2gg9evh47fn9z.cloudfront.net/800px_COLOURBOX17614063.jpg',
    Height: 0,
    Width: 0,
    Start : {X: 0, Y: 0},
    End : {X: 0, Y: 0},
  ...
  async componentDidMount(){
    ...
    const filename = 'https://d2gg9evh47fn9z.cloudfront.net/800px_COLOURBOX17614063.jpg';
    ...
    <Layout>
     ...
     <h1>Nate's Maze Solver</h1>
      ...
      <Wrapper>
        ...
        <Slider HandleSlide = {this.HandleSlide} max = {this.state.Width} id = "W3" type = "Staaaaaart(red) Left/Right"/>
        <Slider HandleSlide = {this.HandleSlide} max = {this.state.Width} id = "W4" type = "End(greeeen) Left/Right"/>
